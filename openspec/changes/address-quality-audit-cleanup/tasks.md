...
- [ ] 6.2 Commit by finding area: coordinator harness, store helper, media cleanup, residual steps logging cleanup.
- [ ] 6.3 Rebase once more on latest `upstream/main` after validation and before pushing.
