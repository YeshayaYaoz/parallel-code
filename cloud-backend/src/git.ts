...
// pushTask() (streams `git push` progress to a renderer BrowserWindow) is
// intentionally not ported here — it's a live-terminal-progress UI concern
// the coordinator doesn't need; coordinator.ts never imports it.
