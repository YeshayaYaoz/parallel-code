// Sub-task worktree lifecycle for the coordinator, adapted from
// electron/ipc/tasks.ts. Deliberately narrower: the original also stops a
// task's plan.md/steps.json file watchers (stopPlanWatcher/stopStepsWatcher)
// on delete — that's a renderer-side-panel live-update convenience with no
// equivalent in this headless service, so there's nothing to stop here.
